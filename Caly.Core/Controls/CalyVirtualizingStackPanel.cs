...
namespace Caly.Core.Controls
{
    ...
    /// </summary>
    public class CalyVirtualizingStackPanel : VirtualizingPanel, IScrollSnapPointsInfo
    {
        /// <summary>
        /// Defines the <see cref="Orientation"/> property.
        /// </summary>
        public static readonly StyledProperty<Orientation> OrientationProperty =
            StackPanel.OrientationProperty.AddOwner<CalyVirtualizingStackPanel>();
        ...
        public static readonly StyledProperty<bool> AreHorizontalSnapPointsRegularProperty =
            AvaloniaProperty.Register<CalyVirtualizingStackPanel, bool>(nameof(AreHorizontalSnapPointsRegular));
        ...
        public static readonly StyledProperty<bool> AreVerticalSnapPointsRegularProperty =
            AvaloniaProperty.Register<CalyVirtualizingStackPanel, bool>(nameof(AreVerticalSnapPointsRegular));
        ...
        public static readonly RoutedEvent<RoutedEventArgs> HorizontalSnapPointsChangedEvent =
            RoutedEvent.Register<CalyVirtualizingStackPanel, RoutedEventArgs>(
        ...
        private static readonly AttachedProperty<object?> RecycleKeyProperty =
            AvaloniaProperty.RegisterAttached<CalyVirtualizingStackPanel, Control, object?>("RecycleKey");
        ...
        public CalyVirtualizingStackPanel()
        {
        ...
        /// <summary>
        /// Gets or sets whether the horizontal snap points for the <see cref="CalyVirtualizingStackPanel"/> are equidistant from each other.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets whether the vertical snap points for the <see cref="CalyVirtualizingStackPanel"/> are equidistant from each other.
        /// </summary>
        ...
        {
            System.Diagnostics.Debug.Assert(_realizedElements is not null);
        ...
        {
            System.Diagnostics.Debug.Assert(_measureElements is not null);
            System.Diagnostics.Debug.Assert(_realizedElements is not null);
        ...
        {
            System.Diagnostics.Debug.Assert(ItemContainerGenerator is not null);
            ...
            ref Control? specialElement)
        {
            ...
            {
                System.Diagnostics.Debug.Assert(specialElement is not null);
        ...
        {
            System.Diagnostics.Debug.Assert(ItemsControl is not null);
            System.Diagnostics.Debug.Assert(ItemContainerGenerator is not null);
