...
namespace Caly.Pdf.Layout
{
    ...
    /// </summary>
    public sealed class CalyNNWordExtractor // : IWordExtractor
    {
        ...
        public IEnumerable<PdfWord> GetWords(IReadOnlyList<PdfLetter> letters)
        {
        ...
        private static IEnumerable<PdfWord> GetWords(IReadOnlyList<PdfLetter> letters,
            ...
            Func<PdfLetter, PdfLetter, bool> filterFunction, int maxDegreeOfParallelism)
        {
            if (letters == null || letters.Count == 0)
            {
                yield break;
            ...
            {
                yield return new PdfWord(g, default, 0, 0, 0);
            }
        }
        ...
        /// </summary>
        public class CalyNNWordExtractorOptions //: IWordExtractorOptions
        {
            /// <summary>
            /// <inheritdoc/>
            /// Default value is -1.
