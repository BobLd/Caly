...
{
    public sealed record PdfWord : IPdfTextElement
    {
#if DEBUG
        ...
        public PdfWord(IReadOnlyList<PdfLetter> letters, PdfRectangle boundingBox, int indexInPage, int textLineIndex, int textBlockIndex)
        {
