...
{
    public sealed record PdfTextBlock : IPdfTextElement
    {
        ...
        public PdfTextBlock(IReadOnlyList<PdfTextLine> textLines, PdfRectangle boundingBox, int indexInPage, int wordStartIndex, int wordEndIndex)
        {
        ...
        {
            var line = FindTextLineOver(x, y);
            return line?.FindLetterOver(x, y);
        }
